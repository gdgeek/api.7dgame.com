...
class SystemUpgradeTest extends TestCase
{
    ...
    private function createResource(int $fileId): Resource
    {
        ...
        $resource->uuid = \Faker\Provider\Uuid::uuid();
        $resource->save(false);
    ...
    {
        $existingUuid = \Faker\Provider\Uuid::uuid();
    ...
    public function testMetaRefreshResourcesRemovesOldResources(): void
    {
        ...
        $meta = $this->createMeta(['uuid' => \Faker\Provider\Uuid::uuid(), 'data' => []]);
    ...
    {
        $meta = $this->createMeta(['uuid' => \Faker\Provider\Uuid::uuid()]);
    ...
    {
        $meta1 = $this->createMeta(['uuid' => \Faker\Provider\Uuid::uuid()]);
        $meta2 = $this->createMeta(['uuid' => \Faker\Provider\Uuid::uuid()]);

        $verse = $this->createVerse(['uuid' => \Faker\Provider\Uuid::uuid(), 'data' => []]);
    ...
    public function testVerseRefreshMetasWithMultipleMetas(): void
    {
        $metas = [];
        for ($i = 0; $i < 3; $i++) {
            $metas[] = $this->createMeta(['uuid' => \Faker\Provider\Uuid::uuid()]);
        }
    ...
    {
        $meta = $this->createMeta(['uuid' => \Faker\Provider\Uuid::uuid(), 'data' => null]);
        $meta->refreshResources();
    ...
    {
        $verse = $this->createVerse(['uuid' => \Faker\Provider\Uuid::uuid(), 'data' => null]);
        $verse->refreshMetas();
