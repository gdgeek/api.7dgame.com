...
class EnvController extends Controller
{
    ...
    private function getRequiredVariables()
    {
        return [
            ...
            '密码策略' => [
                'PASSWORD_MIN_LENGTH' => ['description' => '最小密码长度', 'required' => false, 'default' => '8'],
                'PASSWORD_MAX_LENGTH' => ['description' => '最大密码长度', 'required' => false, 'default' => '64'],
                'PASSWORD_MIN_CHARACTER_CATEGORIES' => ['description' => '最少字符类别数', 'required' => false, 'default' => '3'],
                'PASSWORD_REQUIRE_UPPERCASE' => ['description' => '将大写字母计入密码类别', 'required' => false, 'default' => 'true'],
                'PASSWORD_REQUIRE_LOWERCASE' => ['description' => '将小写字母计入密码类别', 'required' => false, 'default' => 'true'],
                'PASSWORD_REQUIRE_DIGIT' => ['description' => '将数字计入密码类别', 'required' => false, 'default' => 'true'],
                'PASSWORD_REQUIRE_SPECIAL' => ['description' => '将特殊字符计入密码类别', 'required' => false, 'default' => 'true'],
