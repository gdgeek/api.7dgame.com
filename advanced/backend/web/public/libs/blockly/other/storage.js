...
BlocklyStorage.backupOnUnload = function (opt_workspace) {
	//alert("BlocklyStorage.backupOnUnload");
...
//	alert("BlocklyStorage.restoreBlocks");
//	alert(BlocklyStorage.dom);

	var xml = Blockly.Xml.textToDom(BlocklyStorage.dom);
	var workspace = opt_workspace || Blockly.getMainWorkspace();
	workspace.clear();
...
BlocklyStorage.retrieveXml = function (key, opt_workspace) {
	...
	alert("BlocklyStorage.retrieveXml");
  var workspace = opt_workspace || Blockly.getMainWorkspace();
