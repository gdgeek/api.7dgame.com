...
$(() => {
  ...
  function preload() {
    $(window).on('load', () => {
      const imgList = [
        '/public/weui/example/images/layers/content.png',
        '/public/weui/example/images/layers/navigation.png',
        '/public/weui/example/images/layers/popout.png',
        '/public/weui/example/images/layers/transparent.gif'
      ]
